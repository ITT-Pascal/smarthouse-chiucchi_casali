...
{
    public class AutoSwitchOffNightThermostatCommand
    {
        private readonly IThermostatRepository _repository;

        public AutoSwitchOffNightThermostatCommand(IThermostatRepository repository)
        {
        ...
        public void Execute(Guid id)
        {
            ...
            if (thermostat != null)
            {
                thermostat.AutoSwitchOffWhenIsNight();
