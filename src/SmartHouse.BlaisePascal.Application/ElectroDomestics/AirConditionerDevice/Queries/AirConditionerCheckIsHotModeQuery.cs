...
{
    public class AirConditionerCheckIsHotModeQuery
    {
        private readonly IAirConditionerRepository _repository;

        public AirConditionerCheckIsHotModeQuery(IAirConditionerRepository repository)
        {
        ...
        public bool Execute(Guid id)
        {
            ...
            if (ac != null)
            {
                if (ac.Mode == AirConditionerMode.Hot)
                    return true;
            }
            return false;
        }
