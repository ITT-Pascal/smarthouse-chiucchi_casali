...
{
    public class EcoHot_AirConditioner : Abstract_AirConditioner
    {
        //Override costante di temperatura massima
        private new const int DefaultTemperature = 30;
        private new const int MinTemperature = 25;
        //Costruttore
        public EcoHot_AirConditioner(string name) : base(name) { }
